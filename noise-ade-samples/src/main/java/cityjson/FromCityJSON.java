...
public class FromCityJSON {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CityModel cityModel;
        try (CityJSONReader reader = in.createCityJSONReader(new File("datasets/railway_example.json"))) {
        ...
        try (CityGMLWriter writer = out.createCityGMLWriter(new File("output/railway_example.gml"))) {
        ...
        System.out.println(df.format(new Date()) + "CityGML file railway_example.gml written");
