...
public class ToCityJSON {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(df.format(new Date()) + "reading ADE-enriched CityGML file railway_example.gml");
        CityGMLInputFactory in = builder.createCityGMLInputFactory();

        CityModel cityModel;
        try (CityGMLReader reader = in.createCityGMLReader(new File("datasets/railway_example.gml"))) {
        ...
        try (CityJSONWriter writer = out.createCityJSONWriter(new File("output/railway_example.json"))) {
            // use indentation
            writer.setIndent(" ");
        ...
        System.out.println(df.format(new Date()) + "CityJSON file railway_example.json written");
